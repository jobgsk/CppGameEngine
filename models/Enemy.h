...
#include "../amodels/ObeseMaleAnime.h"
...
public:
	...
	EnemyBehave(GameObject* current_object);
...
public:
	...
	*/
	...
	EnemyModel(int i, Vector3 pos, float scale, Quaternion q1) :GameObject()
	{
		m_id = i;
		half_size = Vector3(0.2, 0.8, 0.2);
		...
		walk_anim = new ObeseMaleAnime(this);
