...
public:
	...
	StaticModelLoader(const char* path, const char *mpath);
	~StaticModelLoader();
...
ModelsStruct *CopyModel(StaticModelLoader* model, float scale);

ModernModelsStruct *ModernCopyModel(StaticModelLoader* model);
ModernModelsStruct *ModernCopyModel(StaticModelLoader* model, float scale);
ModernModelsStruct *ModernCopyModel(StaticModelLoader* model, float scale, glm::vec4 color);
